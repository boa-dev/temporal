...
use super::{calendar::CalendarProtocol, tz::TzProtocol, Date, Time};
...
impl Duration {
    ...
    #[inline]
    pub fn round_v2<C: CalendarProtocol, Z: TzProtocol>(
        &self,
        ...
        let _precalculated: Option<DateTime<C>> = if relative_to.zdt.is_some() && pdtr_will_be_used
        {
...
#[allow(clippy::too_many_arguments)]
pub(crate) fn nudge_calendar_unit<C: CalendarProtocol, Z: TzProtocol>(
    sign: i32,
    ...
    let (r1, r2, start_duration, end_duration) = match unit {
        ...
        TemporalUnit::Week => {
            ...
            let until_result =
                weeks_start.internal_diff_date(&weeks_end, TemporalUnit::Week, context)?;
...
#[inline]
#[allow(clippy::too_many_arguments)]
fn bubble_relative_duration<C: CalendarProtocol, Z: TzProtocol>(
    sign: i32,
    duration: &NormalizedDurationRecord,
    nudge_epoch_ns: i128,
...
#[allow(clippy::too_many_arguments)]
#[inline]
pub(crate) fn round_relative_duration<C: CalendarProtocol, Z: TzProtocol>(
    duration: &NormalizedDurationRecord,
    dest_epoch_ns: i128,
    dt: &DateTime<C>,
    tz: Option<Z>,
