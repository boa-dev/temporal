...
impl Duration {
    ...
    /// The internal implementation of adding/subtracting `Duration`s
    #[inline]
    pub(crate) fn internal_add(&self, other: &Self) -> TemporalResult<Self> {
        // NOTE: 1-22 are functionally useless in this context.
...
impl Duration {
    ...
    pub fn subtract(&self, other: &Self) -> TemporalResult<Self> {
        self.internal_add(&other.negated())
    }
