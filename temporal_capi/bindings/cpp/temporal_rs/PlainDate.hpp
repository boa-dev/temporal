...
namespace capi {
    ...
    typedef struct temporal_rs_PlainDate_epoch_ms_for_result {union {int64_t ok; temporal_rs::capi::TemporalError err;}; bool is_ok;} temporal_rs_PlainDate_epoch_ms_for_result;
    temporal_rs_PlainDate_epoch_ms_for_result temporal_rs_PlainDate_epoch_ms_for(const temporal_rs::capi::PlainDate* self, temporal_rs::capi::TimeZone time_zone);

    typedef struct temporal_rs_PlainDate_epoch_ms_for_with_provider_result {union {int64_t ok; temporal_rs::capi::TemporalError err;}; bool is_ok;} temporal_rs_PlainDate_epoch_ms_for_with_provider_result;
    temporal_rs_PlainDate_epoch_ms_for_with_provider_result temporal_rs_PlainDate_epoch_ms_for_with_provider(const temporal_rs::capi::PlainDate* self, temporal_rs::capi::TimeZone time_zone, const temporal_rs::capi::Provider* p);
...
inline temporal_rs::diplomat::result<int64_t, temporal_rs::TemporalError> temporal_rs::PlainDate::epoch_ms_for(temporal_rs::TimeZone time_zone) const {
    auto result = temporal_rs::capi::temporal_rs_PlainDate_epoch_ms_for(this->AsFFI(),
        time_zone.AsFFI());
...
inline temporal_rs::diplomat::result<int64_t, temporal_rs::TemporalError> temporal_rs::PlainDate::epoch_ms_for_with_provider(temporal_rs::TimeZone time_zone, const temporal_rs::Provider& p) const {
    auto result = temporal_rs::capi::temporal_rs_PlainDate_epoch_ms_for_with_provider(this->AsFFI(),
        time_zone.AsFFI(),
        p.AsFFI());
    return result.is_ok ? temporal_rs::diplomat::result<int64_t, temporal_rs::TemporalError>(temporal_rs::diplomat::Ok<int64_t>(result.ok)) : temporal_rs::diplomat::result<int64_t, temporal_rs::TemporalError>(temporal_rs::diplomat::Err<temporal_rs::TemporalError>(temporal_rs::TemporalError::FromFFI(result.err)));
}
