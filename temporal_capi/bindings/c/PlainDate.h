...
typedef struct temporal_rs_PlainDate_epoch_ms_for_result {union {int64_t ok; TemporalError err;}; bool is_ok;} temporal_rs_PlainDate_epoch_ms_for_result;
temporal_rs_PlainDate_epoch_ms_for_result temporal_rs_PlainDate_epoch_ms_for(const PlainDate* self, TimeZone time_zone);

typedef struct temporal_rs_PlainDate_epoch_ms_for_with_provider_result {union {int64_t ok; TemporalError err;}; bool is_ok;} temporal_rs_PlainDate_epoch_ms_for_with_provider_result;
temporal_rs_PlainDate_epoch_ms_for_with_provider_result temporal_rs_PlainDate_epoch_ms_for_with_provider(const PlainDate* self, TimeZone time_zone, const Provider* p);
